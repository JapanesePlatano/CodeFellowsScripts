...
# Date of latest revision:      06/05/2024
...
# Source1:                      https://realpython.com/python-logging/#using-handlers
# Source2:                      https://github.com/codefellows/seattle-cybersecurity-401d12/blob/main/class-28/challenges/DEMO.md
...
rotating_handler = RotatingFileHandler('network_monitor.log', maxBytes=5*1024*1024, backupCount=5)  # 5 MB
...
def main():
    ...
    while True:
        ...
        if current_status != previous_status:
            ...
            logger.info(f"{timestamp} Status changed from {previous_status} to {current_status} for {destination_ip}")
            previous_status = current_status
        else:
            logger.debug(f"{timestamp} Network {current_status} to {destination_ip}")
